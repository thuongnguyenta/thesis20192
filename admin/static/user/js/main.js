...
$(document).ready(function(){
  ...
  $("input[type=radio]").change(function(){
    ...
    //   '<img class="img-fluid" src="'+src_link+'" alt="">'+
    // '</div>');
    //   }
      
    });
    // $(".image_element").each(function(){
    //   var display_cl=$(this).css('display');
    //   // alert(display_cl);
    //   if(display_cl!="none"){
    //   var src_temp=$(this).find('img').attr('src');
    //   // alert(src_temp+display_cl);
    //   $('.s_Product_carousel').append('<div class="single-prd-item" color="">'+
    //   '<img class="img-fluid" src="'+src_temp+'" alt="">'+
    // '</div>');
    // }
    // });
...
//   $(function() {
  //   $(".shoe_quantity").change(function(event){
  //     alert("1");
  //     var _this = this;
  //     // alert(_this.id);
  //     var temp=_this.id;
  //     var quantity=_this.data();
  //     alert(quantity);
  //     $.ajax({
  //       data: {
  //         quantity=quantity
...
// });
  ...
  //------- Active Nice Select --------//
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        loop:true,
        nav:true,
        navText:["<img src='../static/user/img/banner/prev.png'>","<img src='../static/user/img/banner/next.png'>"],
        dots:false
    });
